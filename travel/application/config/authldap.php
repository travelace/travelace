...
$config['login_attribute'] = 'sAMAccountName';#SamAccountname
$config['schema_type'] = 'ad'; // Use rfc2307, rfc2307bis, or ad
$config['proxy_user'] = 'CN=ldapuser,CN=Users,DC=CORPWIMAC,DC=COM';
$config['proxy_pass'] = 'Pzur3020#';
$config['roles'] = array(1 => 'Corpwimac',
                         5 => 'AdminisUserstradores');
